    ...
    <div className="CrimeContainer">
      {news.slice(0,4).map((article, index) => (
        <div className="CrimeCard" key={index}>
          <div className="CrimeBadge">{article.location || "सागर"}</div>
          <img
            src={CardImg2} 
            alt="Shivraj"
          ...
          <div className="CrimeCardContent">
            <h2 className="CrimeCardTitle">{article.heading}</h2>
            <p className="CrimeCardDescription">
             {article.mainNews}
            </p>
            <div className="CrimeCardFooter">
              <div className="CrimeAuthorInfo">
                <span className="CrimeAuthor">By Abhishek Sharma</span>
              ...
              <IoShareSocialOutline 
                ...
                onClick={() => {
                  if (navigator.share) {
                    ...
                    const shareUrl = `${window.location.href}?article=${encodeURIComponent(article.heading)}&category=crime`;
